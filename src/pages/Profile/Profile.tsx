                ...
                <div className="p-6 rounded-3xl border border-red-500/20 bg-slate-900/40 relative z-10">
                    <div className="flex flex-col md:flex-row items-center gap-6">
                        ...
                        <button
                            ...
                            className="px-8 py-4 bg-red-600 hover:bg-red-500 text-white rounded-2xl font-black text-xs tracking-widest transition-all shadow-lg shadow-red-900/40 flex items-center gap-3 whitespace-nowrap"
                        >
                            <LogOut className="w-4 h-4" /> HAPUS AKUN
                        </button>
                    </div>
                </div>
            </div>
