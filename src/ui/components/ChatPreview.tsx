                ...
                <div className="bg-slate-900 border border-slate-800 rounded-3xl w-full max-w-2xl h-[80vh] flex flex-col shadow-2xl overflow-hidden">
                                ...
                                >
                                    <div className={`max-w-[80%] p-4 rounded-2xl shadow-lg relative ${msg.role === 'user'
                                        ...
                                        <div className="flex items-center gap-2 mb-2 opacity-50 text-[10px] font-bold uppercase tracking-wider">
                                            ...
                                            {msg.role === 'user' ? pushName : 'AI Assistant'}
                                        </div>
                                            ...
                                            <div className="mb-2 overflow-hidden rounded-xl border border-white/10 bg-black/20">
                                                {msg.media_type === 'image' && (
                                                    <img
                                                        src={msg.media_url}
                                                        alt="Media"
                                                        className="max-h-60 w-full object-cover cursor-zoom-in hover:opacity-90 transition-opacity"
                                                        onClick={() => setSelectedImg(msg.media_url!)}
                                                    />
                                                )}
                    ...
                    <div className="p-4 bg-slate-950/50 border-t border-slate-800 text-center">
                        <p className="text-[10px] text-slate-500 font-medium">
                            AI Bot Mode is Active • Media stored in Supabase
                        </p>
                    </div>
                </div>
            </motion.div>
